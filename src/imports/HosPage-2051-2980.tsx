import svgPaths from "./svg-6jdryrm8i4";
...
function Widgets() {
  return (
    <div className="bg-[#0e2e4b] content-stretch flex flex-col items-start p-[16px] relative rounded-[16px] shrink-0 w-[341px]" data-name="Widgets">
...
function Frame15() {
  return <BackgroundImage2>{`What's My HOS Status`}</BackgroundImage2>;
}
...
function QuickActions() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-center justify-end min-h-px min-w-px relative shrink-0 w-full" data-name="Quick Actions">
      ...
      <Frame15 />
      <BackgroundImageAndText text="How far till the weigh-station" />
      <BackgroundImageAndText text="Certify logs" />
      <BackgroundImageAndText text="Load Summary" />
    </div>
  );
}
