import svgPaths from "./svg-noe1yg62w9";
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <p className="basis-0 font-['Roboto:Light_Italic',sans-serif] font-light grow italic leading-[normal] min-h-px min-w-px relative shrink-0 text-[16px] text-center text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        “You’re hauling a refrigerated load with three stops. You’re currently headed to Walmart Distribution 32 in Los Angeles with an 8:00 a.m. appointment.You’re on schedule, about 350 miles total, and this load is marked hazmat.”
      </p>
    </div>
  );
}
...
function Icon2() {
  return (
    <IconBackgroundImage>
      <g clipPath="url(#clip0_2035_2437)" id="icon" opacity="0.75">
        <path d={svgPaths.p24e89c00} fill="var(--fill-0, #3D3D3D)" id="Vector" />
      </g>
      <defs>
        <clipPath id="clip0_2035_2437">
          <rect fill="white" height="14" width="14" />
        </clipPath>
      </defs>
    </IconBackgroundImage>
...
function LoadSummaryWidget() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Load summary widget">
