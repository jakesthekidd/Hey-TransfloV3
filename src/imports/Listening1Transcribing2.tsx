import svgPaths from "./svg-v9o3jcq2w9";
...
function Group3() {
  return (
    <div className="h-[28.438px] relative shrink-0 w-[20.682px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.6821 28.4379">
        <g id="Group 289907">
          <path d={svgPaths.pc5ac380} fill="var(--fill-0, white)" id="Vector" opacity="0.95" />
          <path d={svgPaths.p1dddec80} fill="var(--fill-0, white)" id="Vector_2" opacity="0.95" />
          <path d={svgPaths.p384d600} fill="var(--fill-0, white)" id="Vector_3" opacity="0.95" />
        </g>
      </svg>
    </div>
  );
...
function MicIcon() {
  return (
    <div className="bg-[rgba(255,255,255,0.2)] content-stretch flex items-center justify-center px-[22.5px] py-0 relative rounded-[50.85px] shadow-[0px_1.8px_1.8px_0px_rgba(0,0,0,0.25)] shrink-0 size-[90px]" data-name="Mic icon">
      <Group3 />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
      ...
      <div className="bg-[rgba(94,179,224,0.7)] h-[40px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[28px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[28px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[40px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[40px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[28px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[50px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[28px] rounded-[30px] shrink-0 w-[7px]" />
      <div className="bg-[rgba(94,179,224,0.7)] h-[40px] rounded-[30px] shrink-0 w-[7px]" />
    </div>
  );
...
function MessageSpace() {
  return (
    <div className="content-stretch flex items-center justify-center px-0 py-[24px] relative shrink-0" data-name="Message Space">
      <div className="font-['Roboto:Black',sans-serif] font-black leading-[normal] relative shrink-0 text-[24px] text-center text-white w-[357px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="mb-0">{`Send a message. `}</p>
        <p>I will be there in 45 min...</p>
      </div>
    </div>
  );
}
...
export default function Listening1Transcribing() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="listening 1 Transcribing 2">
      <Dachboard />
      <IPhone />
      <SiriAnimation />
      <Stars />
