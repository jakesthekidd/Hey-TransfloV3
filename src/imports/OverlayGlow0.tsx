import svgPaths from "./svg-21xuriq9yl";
...
function SafeSpave() {
  return <div className="absolute h-[844px] left-0 top-0 w-[389px]" data-name="Safe spave" />;
}

export default function OverlayGlow() {
  return (
    <div className="relative size-full" data-name="Overlay & Glow 0">
      <IPhone />
      <SiriAnimation />
      <Stars />
      <SafeSpave />
