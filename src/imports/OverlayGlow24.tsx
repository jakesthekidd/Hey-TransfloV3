import svgPaths from "./svg-yettbili55";
...
function SiriAnimation() {
  return (
    <div className="absolute h-[844px] left-[calc(50%-0.5px)] opacity-50 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[393px]" data-name="SiriAnimation">
      <div className="absolute blur-[1px] border-2 border-[#95d9f7] border-solid filter h-[852px] left-0 rounded-[24px] top-0 w-[393px]" data-name="Blur S" />
      <div className="absolute blur-[2px] border-[#95d9f7] border-[5px] border-solid filter h-[852px] left-0 rounded-[24px] top-0 w-[393px]" data-name="Blur M" />
      <div className="absolute blur-[5px] border-[#95d9f7] border-[7px] border-solid filter h-[852px] left-0 rounded-[24px] top-0 w-[393px]" data-name="Blur L" />
      <div className="absolute blur-[10px] border-[#95d9f7] border-[10px] border-solid filter h-[852px] left-0 mix-blend-hard-light rounded-[24px] top-0 w-[393px]" data-name="Blur XL" />
    </div>
  );
}
...
export default function OverlayGlow() {
  return (
    <div className="overflow-clip relative rounded-[24px] size-full" data-name="Overlay & Glow 24">
      <IPhone />
      <SiriAnimation />
      <Stars />
    </div>
