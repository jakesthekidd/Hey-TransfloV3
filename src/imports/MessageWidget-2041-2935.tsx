import svgPaths from "./svg-z8cahg83jp";
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[12px] relative w-full">
          <p className="basis-0 font-['Roboto:Regular',sans-serif] font-normal grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#e9f1f8] text-[16px] text-center" style={{ fontVariationSettings: "'wdth' 100" }}>
            You should arrive at your destination in approximately 45 minutes, putting your estimated time of arrival at 7:30 PM.
          </p>
        </div>
      </div>
    </div>
...
function AnswerWidget() {
  return (
    <div className="bg-[#0e2e4b] relative rounded-[16px] shrink-0 w-full" data-name="answer widget">
