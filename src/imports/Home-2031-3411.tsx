import svgPaths from "./svg-64jm25g9g4";
...
function Frame16() {
  return <BackgroundImage2>{`Send Message to {FleetID}`}</BackgroundImage2>;
}

function Frame17() {
  return <BackgroundImage2>{`How far till the weigh  station`}</BackgroundImage2>;
}
...
export default function Home() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="Home">
      <Dachboard />
      <IPhone />
      <SiriAnimation />
      <Stars />
