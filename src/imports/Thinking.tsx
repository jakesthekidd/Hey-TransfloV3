import svgPaths from "./svg-o3eed03dwo";
...
import imgCirclesAnimation from "figma:asset/5948e06c560583c9167d2db4fdd76c038532091e.png";
import imgCirclesAnimation1 from "figma:asset/189fc80f49884e6502bde06567652e4b540c2078.png";
import imgCirclesAnimation2 from "figma:asset/28d3499fd8ccfd1947a4244248f9b65ba2d0ea40.png";
...
function Frame25() {
  return (
    <div className="content-stretch flex items-center justify-center px-0 py-[16px] relative shrink-0 w-full">
...
function CirclesAnimation() {
  return (
    <div className="[grid-area:1_/_1] blur-[2px] filter ml-0 mt-0 overflow-clip relative size-[281px]" data-name="Circles-Animation">
      <img alt="" className="block max-w-none size-full" height="281" src={imgCirclesAnimation} width="281" />
    </div>
  );
}

function CirclesAnimation1() {
  return (
    <div className="[grid-area:1_/_1] blur-[1px] filter ml-[37.73px] mt-[38.54px] overflow-clip relative size-[204.729px]" data-name="Circles-Animation">
      <img alt="" className="block max-w-none size-full" height="204.729" src={imgCirclesAnimation1} width="204.729" />
    </div>
  );
}

function CirclesAnimation2() {
  return (
    <div className="[grid-area:1_/_1] blur-[1px] filter ml-[77.88px] mt-[78.68px] overflow-clip relative size-[124.443px]" data-name="Circles-Animation">
      <img alt="" className="block max-w-none size-full" height="124.443" src={imgCirclesAnimation2} width="124.443" />
    </div>
  );
}
...
function Circles() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative" data-name="Circles">
      <CirclesAnimation />
      <CirclesAnimation1 />
      <CirclesAnimation2 />
    </div>
...
function LoadingAnimation() {
  return (
    <div className="absolute h-[51.383px] left-[-8px] top-[-29px] w-[58.191px]" data-name="Loading-Animation">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58.1914 51.3829">
        <g id="Loading-Animation">
          <circle cx="11" cy="32" fill="var(--fill-0, white)" id="Ellipse 1" r="3" />
          <circle cx="39" cy="32" fill="var(--fill-0, white)" id="Ellipse 3" r="3" />
          <circle cx="25" cy="32" fill="var(--fill-0, white)" id="Ellipse 2" r="3" />
          <circle cx="53" cy="32" fill="var(--fill-0, white)" id="Ellipse 4" r="3" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="[grid-area:1_/_1] h-[6px] ml-[116px] mt-[138px] relative w-[48px]">
      <LoadingAnimation />
    </div>
  );
}
...
function ThinkingAnamation() {
  return (
    <div className="content-stretch flex items-center p-[19px] relative rounded-[160px] shrink-0 w-[309px]" data-name="Thinking anamation" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 309 319\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(-9.4104e-7 15.95 -15.45 -9.7149e-7 154.5 159.5)\\\'><stop stop-color=\\\'rgba(14,46,75,1)\\\' offset=\\\'0\\\'/><stop stop-color=\\\'rgba(24,77,126,0.5)\\\' offset=\\\'0.5\\\'/><stop stop-color=\\\'rgba(33,109,177,0)\\\' offset=\\\'1\\\'/></radialGradient></defs></svg>')" }}>
      <Group3 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[32px] grow h-full items-center min-h-px min-w-px relative shrink-0">
      <Frame25 />
      <Frame26 />
    </div>
  );
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex h-[844px] items-start justify-center left-0 px-[16px] py-[32px] top-0 w-[389px]">
      <Frame12 />
    </div>
  );
}
...
export default function Thinking() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="Thinking">
      <Dachboard />
      <IPhone />
      <SiriAnimation />
      <Stars />
