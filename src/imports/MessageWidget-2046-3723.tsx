import svgPaths from "./svg-qfc3uruzbb";
...
function IsolationMode() {
  return (
    <BackgroundImage5>
      <g clipPath="url(#clip0_2046_3785)" id="Isolation_Mode">
        <g id="Vector 3">
...
function Icons7() {
  return (
    <BackgroundImage5>
      <g clipPath="url(#clip0_2046_3764)" id="Icons">
...
function Icon2() {
  return (
    <IconBackgroundImage>
      <g clipPath="url(#clip0_2046_3752)" id="icon" opacity="0.75">
        <path d={svgPaths.p24e89c00} fill="var(--fill-0, #3D3D3D)" id="Vector" />
      </g>
      <defs>
        <clipPath id="clip0_2046_3752">
          <rect fill="white" height="14" width="14" />
        </clipPath>
      </defs>
    </IconBackgroundImage>
...
function IsolationMode1() {
  return (
    <BackgroundImage6>
      <g clipPath="url(#clip0_2046_3755)" id="Isolation_Mode">
        <g id="Vector 3">
...
function Icons8() {
  return (
    <BackgroundImage6>
      <g clipPath="url(#clip0_2046_3731)" id="Icons">
...
function LoadSummaryWidget() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-[341px]" data-name="Load summary widget">
