import svgPaths from "./svg-1ww6zza943";
...
function Icon2() {
  return (
    <IconBackgroundImage>
      <g clipPath="url(#clip0_2046_6029)" id="icon" opacity="0.75">
        <path d={svgPaths.p337bac00} fill="var(--fill-0, #3D3D3D)" id="Vector" />
      </g>
      <defs>
        <clipPath id="clip0_2046_6029">
          <rect fill="white" height="14" width="14" />
        </clipPath>
      </defs>
    </IconBackgroundImage>
...
function Frame() {
  return (
    <div className="bg-[#0c2841] relative rounded-[8px] shrink-0 w-fit">
      <div className="flex flex-row items-center">
        <div className="content-stretch flex items-center p-[12px] relative">
          <WordByWordText 
            text={`You're hauling a refrigerated load with three stops. You're currently headed to Walmart Distribution 32 in Los Angeles with an 8:00 a.m appointment. You're on schedule, and this load is marked hazmat.`}
            className="italic"
            wordsPerSecond={3.5}
            style={{
              fontSize: '16px',
...
export default function Widgets() {
  return (
    <div className="relative rounded-[16px] size-full" data-name="Widgets">
