import svgPaths from "./svg-8a3uaug02p";
...
function MessageSpace() {
  return (
    <div className="content-stretch flex items-center justify-center px-0 py-[24px] relative shrink-0" data-name="Message space">
      <p className="font-['Roboto:Black',sans-serif] font-black leading-[normal] relative shrink-0 text-[24px] text-center text-white w-[357px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Send a mess..
      </p>
    </div>
  );
...
export default function Listening1Transcribing() {
  return (
    <div className="overflow-clip relative rounded-[60px] size-full" data-name="listening 1 Transcribing 1">
      <Dachboard />
      <IPhone />
      <SiriAnimation />
      <Stars />
