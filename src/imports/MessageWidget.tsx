import svgPaths from "./svg-4kflf93qm4";
  ...
  return (
    <div className="content-stretch flex items-center justify-center px-0 py-[16px] relative shrink-0 w-full">
      <p className="basis-0 font-['Roboto:Light_Italic',sans-serif] font-light grow italic leading-[normal] min-h-px min-w-px relative shrink-0 text-[16px] text-center text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
        “Send message to Fleet ID: ‘I’ll be there in 45 minutes’. Say Send or Cancel.”
      </p>
    </div>
  );
}
...
function Frame32() {
  return (
    <BackgroundImage4 additionalClassNames="bg-[#0e2e4b]">
...
function Frame33() {
  return (
    <BackgroundImage4 additionalClassNames="bg-[#2474bb]">
...
function Frame21() {
  return (
    <div className="bg-[#0e2e4b] relative rounded-[16px] shrink-0 w-full">
...
function Frame34() {
  return (
    <BackgroundImage4 additionalClassNames="bg-[#f1fafe]">
      <p className="font-['Roboto:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#0e2e4b] text-[16px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Send it?
      </p>
    </BackgroundImage4>
  );
...
function PillButtonRoboto2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Pill Button Roboto 16">
      <Frame34 />
    </div>
  );
}
...
function HomeIndicator() {
  return (
    <div className="absolute h-[34px] left-0 top-[778px] w-[375px]" data-name="Home Indicator">
...
function NativeElements() {
  return (
    <div className="absolute contents left-0 top-[778px]" data-name="Native-Elements">
      <HomeIndicator />
    </div>
  );
}
